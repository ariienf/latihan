    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-10">
        ...
        <div class="overflow-x-auto bg-white shadow-md rounded-lg p-6">
            <p class="text-lg font-semibold mb-4">
                Total Produk : <span class="text-blue-500">{{ $totalProduk }}</span>
            </p>
            <table class="table-auto w-full border-collapse border border-gray-300">
                <thead>
                    <tr class="bg-gray-200 text-center">
                        <th class="border border-gray-300 px-4 py-2 text-sm font-medium">ID</th>
                        <th class="border border-gray-300 px-4 py-2 text-sm font-medium">Nama</th>
                        <th class="border border-gray-300 px-4 py-2 text-sm font-medium">Harga</th>
                        <th class="border border-gray-300 px-4 py-2 text-sm font-medium">Stok</th>
                        <th class="border border-gray-300 px-4 py-2 text-sm font-medium">Kategori</th>
                    </tr>
                </thead>
                <tbody>
